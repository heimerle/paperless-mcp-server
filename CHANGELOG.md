...
### Fixed
- Updated all README examples to use unscoped package name `paperless-mcp-server`
- Added migration notes for users of deprecated `@mweinheimer/paperless-mcp-server` package
- Deprecated old scoped package on npm with redirect message
